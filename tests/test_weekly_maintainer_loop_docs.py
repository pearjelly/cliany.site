...
def test_weekly_maintainer_loop_doc_has_required_sections():
    ...
    required = [
        ...
        "publication_summary.status",
        "publication_summary.worktree_clean",
        "publication_summary.ahead_count",
        "publication_summary.latest_tag",
        "publication_summary.target_tag",
        "publication_summary.target_tag_status",
        "publication_summary.target_tag_release_gate_status",
        "publication_summary.target_tag_release_gate_blocker_count",
        "publication_summary.target_tag_primary_command",
        ...
        "cd site && vercel inspect www.cliany.site --wait --timeout 90s",
        "website_inspect",
        ...
        "publication_tag_publish_decision.target_tag_release_gate_blockers",
