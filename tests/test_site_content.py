...
def test_site_quickstart_matches_v0150_ten_minute_success_path():
    ...
    assert "Current baseline: v0.16.356" in index
    ...
    assert "当前基线：v0.16.356" in script
    ...
    assert 'en: "Current baseline: v0.16.356.' in script
    assert "en: 'Current baseline: v0.16.356." not in script
    ...
    assert "v0.16.356 · Python" in docs
