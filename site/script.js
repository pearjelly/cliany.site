const I18N = {
  ...
  'qs.evidence.desc': { zh: '2026-08-16，已安装的 issues.apache.org active demo 通过严格静态校验，并返回 5 条 Apache Spark 只读 issue 结果。这是可复核的日期化证据，不是 candidate package、live LLM 或第三方服务持续可用性的声明。', en: 'On 2026-08-16, the installed issues.apache.org active demo passed strict static verification and returned five read-only Apache Spark issue results. This is reproducible dated evidence, not a candidate package, live LLM, or ongoing third-party availability claim.' },
