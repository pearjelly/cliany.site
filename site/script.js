const I18N = {
  ...
  'qs.contribute.validate': {
    zh: '候选案例应关联 <code>cases/manifest.json</code>、<code>cases/examples/</code>、<code>python scripts/validate_cases.py --strict</code> 和 <code>cliany-site cases --case-id pypi-project-search --evidence-bundle --json</code>。',
    en: 'Candidate cases should point to <code>cases/manifest.json</code>, <code>cases/examples/</code>, <code>python scripts/validate_cases.py --strict</code>, and <code>cliany-site cases --case-id pypi-project-search --evidence-bundle --json</code>.'
  },
