...
- `scripts/plan_next_iteration.py` 的顶层 JSON 和默认文本输出现在直接展示 `case_promotion_evidence_primary_next_task` 与 `case_promotion_evidence_primary_next_action`，让自动化不用展开 summary 也能定位首要 candidate 任务。
