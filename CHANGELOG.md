...
- Candidate issue artifact files now use stable LF newlines, and POSIX executable-bit integrity assertions no longer run on Windows where that bit is not meaningful.
