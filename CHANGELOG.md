...
- Cases CLI evidence bundles and generated candidate issue bodies now list the exact `cliany-site doctor --llm-live --json` fields to attach when live LLM preflight blocks candidate promotion.
